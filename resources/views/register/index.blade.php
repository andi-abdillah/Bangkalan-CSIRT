                ...
                <form action="/dashboard/users" method="post">
                    ...
                    <div class="mt-3 mb-2">
                        <input type="password" name="password"
                            class="input bg-neutral w-full transition duration-300 focus:outline-none focus:ring focus:ring-2 focus:ring-secondary @error('password') is-invalid @enderror"
