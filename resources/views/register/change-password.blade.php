  ...
  <div class="panel-body">
    ...
    <form class="form-horizontal" autocomplete="off" method="POST" action="/register/showChangePasswordGet">
      ...
      <div class="{{ $errors->has('current-password') ? ' has-error' : '' }} mb-3">
        ...
        <div class="col-md-6">
          <input id="current-password" type="password" class="form-input" name="current-password" required autofocus>
      ...
      <div class="{{ $errors->has('new-password') ? ' has-error' : '' }} mb-3">
        ...
        <div class="col-md-6">
          <input id="new-password" type="password" class="form-input" name="new-password" required aria-describedby="passwordHelpBlock">
      ...
      <div class="mb-3">
        ...
        <div class="col-md-6 mb-1">
          <input id="confirm-password" type="password" class="form-input" name="new-password_confirmation" required>
        </div>
      </div>
      <div class="mb-3 flex">
