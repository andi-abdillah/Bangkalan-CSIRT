...
@section('container')
    ...
    <section class="mb-8">
        ...
        <a href="/dashboard/footers/create" class="btn btn-add mb-3">Create a New Footer <span
                        ...
                        <tr>
                            ...
                            <td class="p-3 flex gap-2">
                                <a class="icon-edit tooltip" data-tip="Edit"
                                    href="/dashboard/footers/{{ $footer->slug }}/edit">
                                    <span class="material-symbols-rounded">
                                        edit
                                    </span>
                                </a>
                                <form class="tooltip" data-tip="Delete" action="/dashboard/footers/{{ $footer->slug }}"
                                    method="post">
                                    @method('delete')
                                    @csrf
