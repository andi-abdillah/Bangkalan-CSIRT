...
<section class="-mt-28 rounded-b-[25px] backdrop-blur-md bg-gradient-to-t from-neutral/90 to-base-100">
  <div class="hero w-5/6 h-96 translate-y-32 mx-auto rounded-[25px] overflow-hidden" style="background-image: url(https://daisyui.com/images/stock/photo-1507358522600-9f71e620c44e.jpg);">
