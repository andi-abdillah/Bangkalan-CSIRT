...
<section class="mb-4">
  ...
  <a href="/dashboard/guidances/create" class="btn btn-add mb-3">Upload a New File <span class="material-symbols-rounded">add</span></a>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="p-3 flex gap-2">
            <a class="icon-edit tooltip" data-tip="Edit" href="/dashboard/guidances/{{ $guidance->slug}}/edit">
              <span class="material-symbols-rounded">
                edit
              </span>
            </a>
            <form class="tooltip" data-tip="Delete" action="/dashboard/guidances/{{ $guidance->slug }}" method="post">
              @method('delete')
              @csrf
