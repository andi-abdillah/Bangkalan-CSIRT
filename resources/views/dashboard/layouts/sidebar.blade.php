<div class="lg:drawer-open">
    ...
    <div class="drawer-side">
        ...
        <ul
            class="flex flex-col gap-1.5 text-[.86rem] w-72 {{ auth()->user()->is_admin ? 'h-max' : 'h-full' }} p-5 lg:m-5 bg-gradient-to-r from-neutral to-neutral/60 backdrop-blur-md drop-shadow-lg rounded-[20px]">
            <li
