      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="p-3 flex gap-2">
            ...
            @can('admin')
            <a class="icon-edit tooltip" data-tip="Edit" href="/dashboard/posts/{{ $post->slug }}/edit">
              <span class="material-symbols-rounded">
                edit
              </span>
            </a>
            <form class="tooltip" data-tip="Delete" action="/dashboard/posts/{{ $post->slug }}" method="post">
              @method('delete')
              @csrf
