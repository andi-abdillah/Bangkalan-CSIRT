...
<section class="mb-4">
  ...
  <a href="/dashboard/profils/create" class="btn btn-add mb-3">Create Profile <span class="material-symbols-rounded">add</span></a>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="p-3 flex gap-2">
            ...
            <a class="icon-edit tooltip" data-tip="Edit" href="/dashboard/profils/{{ ($profil->slug) }}/edit">
              <span class="material-symbols-rounded">
                edit
              </span>
            </a>
            <form class="tooltip" data-tip="Delete" action="/dashboard/profils/{{ ($profil->slug) }}" method="post">
              @method('delete')
              @csrf
