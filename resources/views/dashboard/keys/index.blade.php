...
<section class="mb-4">
  ...
  <a href="/dashboard/keys/create" class="btn btn-add mb-3">Upload a Public Key <span class="material-symbols-rounded">add</span></a>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="p-3 flex gap-2">
            <form class="tooltip" data-tip="Delete" action="/dashboard/keys/{{ $key->name }}" method="post">
              @method('delete')
              @csrf
