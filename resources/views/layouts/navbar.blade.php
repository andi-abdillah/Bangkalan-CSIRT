<!-- Navigation Bar -->
<nav class="relative">
  <div id="navbar" class="navbar fixed top-0 left-0 right-0 flex lg:justify-center text-white transition ease-in-out duration-500 font-bold z-50">
    <div class="navbar-start">
      <div class="dropdown">
        ...
        <ul tabindex="0" class="dropdown-content mt-5 z-[1] p-2 shadow bg-neutral rounded-box w-52">
          ...
          <li class="m-2 p-2"><a class="link-underline {!! Request::is('service') ? 'link-active' : '' !!}" href="/service">Layanan</a></li>
          <li class="m-2 p-2"><a class="link-underline {!! Request::is('guidance') ? 'link-active' : '' !!}" href="/guidance">Panduan</a></li>
          <li class="m-2 p-2"><a class="link-underline {!! Request::is('contact') ? 'link-active' : '' !!}" href="/contact">Kontak</a></li>
        </ul>
      </div>
    ...
    <div class="absolute dropdown dropdown-end right-4 lg:static">
      <label tabindex="0" class="btn btn-ghost rounded-btn">Tema</label>
      <ul id="theme" tabindex="0" class="menu dropdown-content z-[1] p-2 shadow-xl bg-neutral rounded-box w-max mt-6 mx-4">
