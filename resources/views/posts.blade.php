...
<div>
    <div class="container mx-auto py-28 text-center">
        ...
        <div class="flex flex-col my-4 gap-4">
            ...
            <img class="w-11/12 md:w-10/12 lg:w-3/5 mx-auto" src="{{ asset($posts[0]->image) }}" alt="{{ $posts[0]->category->name }}">
            <div class="flex flex-col gap-4 text-center w-11/12 lg:w-3/4 mx-auto">
                ...
                <a href="/posts/{{ $posts[0]->slug }}" class="btn btn-outline w-max mx-auto btn-secondary rounded-none">Read More
