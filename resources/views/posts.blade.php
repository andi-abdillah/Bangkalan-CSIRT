  ...
  <div class="flex justify-center my-8">
    <form action="/posts" class="w-80 lg:w-96 font-bold">
      ...
      <div class="relative">
        ...
        <input type="search" id="default-search" class="rounded-[12px] block w-full p-4 pl-10 text-lg bg-neutral transition duration-300 focus:outline-none focus:ring focus:ring-2 focus:ring-primary" name="search" value="{{ request('search') }}" placeholder="Search...">
